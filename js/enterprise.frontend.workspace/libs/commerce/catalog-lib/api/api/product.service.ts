...
export class ProductService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV1ProductByIdPut(id: string, updateModel?: Product, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public apiV1ProductByIdPut(id: string, updateModel?: Product, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public apiV1ProductByIdPut(id: string, updateModel?: Product, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public apiV1ProductByIdPut(id: string, updateModel?: Product, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
