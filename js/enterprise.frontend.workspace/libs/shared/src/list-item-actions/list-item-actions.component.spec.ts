...
describe('ListItemActionsComponent', () => {
  ...
  describe('UI Tests', () => {
    it('should render name item actions properly', () => {
      expect(listItemActionsComponentPage.itemAction.length).toBe(listItemActionsMocks.length);
      expect(listItemActionsComponentPage.itemAction[0].innerHTML).toContain(listItemActionsMocks[0].name);
      expect(listItemActionsComponentPage.itemAction[3].innerHTML).toContain(listItemActionsMocks[3].name);
    })
  ...
  describe('Functional Tests', () => {
    ...
    it('should emit right id when button edit clicked', () => {
      const editBtn: HTMLButtonElement = listItemActionsComponentPage.itemAction[0].querySelector('.list-item-actions__item__edit > button');
    ...
    it('should emit right id when delete clicked', () => {
      const deleteBtn: HTMLButtonElement = listItemActionsComponentPage.itemAction[0].querySelector('.list-item-actions__item__delete > button');
