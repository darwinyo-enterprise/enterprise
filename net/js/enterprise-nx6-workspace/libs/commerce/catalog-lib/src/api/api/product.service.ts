...
export class ProductService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV1ProductByIdGet(id: string, observe?: 'body', reportProgress?: boolean): Observable<ProductViewModel>;
    public apiV1ProductByIdGet(id: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ProductViewModel>>;
    public apiV1ProductByIdGet(id: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ProductViewModel>>;
    public apiV1ProductByIdGet(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<ProductViewModel>(`${this.basePath}/api/v1/Product/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV1ProductByIdPut(id: string, updateModel?: ProductViewModel, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public apiV1ProductByIdPut(id: string, updateModel?: ProductViewModel, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public apiV1ProductByIdPut(id: string, updateModel?: ProductViewModel, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public apiV1ProductByIdPut(id: string, updateModel?: ProductViewModel, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
