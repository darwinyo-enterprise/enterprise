...
namespace Enterprise.Commerce.IntegrationTests.Services.Catalog.API
{
        ...
        : CatalogScenarioBase
    {
        ...
        private async Task<ProductViewModel> GetTestProductVIewModelAsync(CatalogContext ctx)
        {
            var targetCategory = await ctx.Categories.FirstOrDefaultAsync();
            var targetManufacturer = await ctx.Manufacturers.FirstOrDefaultAsync();
            return new ProductViewModel()
            {
                ...
                ProductImages = new[]
                {
                    ...
                    {
                        ImageName = "test.png",
                        ImageUrl = "data:image/png;base64,"
                    }, new ProductImage()
                    {
                        ImageName = "test1.png",
                        ImageUrl = "data:image/png;base64,"
        ...
        private async Task<Product> SeedTestProductAsync(CatalogContext ctx, TestServer server)
        {
            ...
            var verifyProduct =
                await ctx.Products.SingleOrDefaultAsync(x => x.Name == viewModel.Name);

            if (verifyProduct != null)
            {
                ctx.Products.Remove(verifyProduct);
        ...
        public async Task Get_product_response_ok_status_code_should_return_all_products()
        {
            using (var server = CreateServer())
            {
                ...
                response.EnsureSuccessStatusCode();
                var result =
                    JsonConvert.DeserializeObject<PaginatedCatalogViewModel<CatalogItemViewModel>>(await response.Content.ReadAsStringAsync());
        ...
        public async Task Get_Product_by_id_response_ok_status_code_with_correct_result()
        {
            ...
            {
                var ctx = server.Host.Services.GetRequiredService<CatalogContext>();
                var productSelected = await ctx.Products.FirstOrDefaultAsync();
                ...
                var result = JsonConvert.DeserializeObject<ProductViewModel>(await response.Content.ReadAsStringAsync());
                ...
                Assert.Equal(productViewModel.ProductColors, result.ProductColors);
                Assert.Equal(productViewModel.ProductImages, result.ProductImages);
        ...
        public async Task Get_product_by_id_response_ok_status_code_return_base64_instead_of_http_url()
        {
            using (var server = CreateServer())
            {
                ...
                {
                    Assert.Contains("base64", image.ImageUrl);
                }
            }
        }
        ...
        public async Task Add_product_response_ok_status_code_should_add_file_in_directory()
        {
            using (var server = CreateServer())
            {
                ...
                var insertedId = response.Headers.Location.Query.Split('=')[1];

                var imgCount = productViewModel.ProductImages.Length;
        ...
        public async Task Update_product_response_ok_status_code_should_replace_file_in_directory()
        {
            using (var server = CreateServer())
            {
                ...
                var testProduct = await ctx.Products
                    .Include(x => x.ProductImages)
                    .Include(x => x.ProductColors)
                    .SingleOrDefaultAsync(x => x.Name == productNameToUpdate);
                ...
                var response = await server.CreateClient()
                    .PutAsync(Put.UpdateProduct(verifyProduct.Id), content);
                ...
                foreach (var productImage in productViewModel.ProductImages)
                {
                    var targetDir = hostingEnvironment.WebRootPath + "\\ProductImage\\" + insertedId + "\\" +
        ...
        public async Task Update_product_response_ok_status_code_should_persisted_in_db()
        {
            using (var server = CreateServer())
            {
                ...
                var response = await server.CreateClient()
                    .PutAsync(Put.UpdateProduct(productViewModel.Id), content);
        ...
        public async Task Delete_product_should_delete_file_and_folder_in_directory()
        {
            using (var server = CreateServer())
            {
                ...
                for (int i = 0; i < imgCount; i++)
                {
                    var targetDir = hostingEnvironment.WebRootPath + "\\ProductImage\\" + productViewModel.Id + "\\" +
                                    productViewModel.ProductImages[i].ImageName;
        ...
        public async Task Delete_product_should_properly_delete_record_in_db()
        {
            using (var server = CreateServer())
            {
                ...
                var deletedProduct =
                    await ctx.Products.SingleOrDefaultAsync(x => x.Name == productToDelete.Name);
