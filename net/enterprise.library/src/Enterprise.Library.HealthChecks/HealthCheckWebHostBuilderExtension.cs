...
namespace Enterprise.Library.HealthChecks
{
    public static class HealthCheckWebHostBuilderExtension
    {
        ...
        {
            return UseHealthChecks(builder, port, DefaultTimeout);
        }
        ...
        public static IWebHostBuilder UseHealthChecks(this IWebHostBuilder builder, int port, TimeSpan timeout)
        {
            ...
            Guard.ArgumentValid(timeout > TimeSpan.Zero, nameof(timeout),
                "Health check timeout must be a positive time span.");
        ...
        {
            return UseHealthChecks(builder, path, DefaultTimeout);
        }
        ...
        public static IWebHostBuilder UseHealthChecks(this IWebHostBuilder builder, string path, TimeSpan timeout)
        {
            ...
            builder.ConfigureServices(services =>
                services.AddSingleton<IStartupFilter>(new HealthCheckStartupFilter(path, timeout)));
            return builder;
        }
    }
}