...
namespace Order.API.Application.Commands
{
        ...
        : IRequestHandler<CreateOrderCommand, bool>
    {
        ...
        public async Task<bool> Handle(CreateOrderCommand message, CancellationToken cancellationToken)
        {
            ...
            var order = new Domain.AggregatesModel.OrderAggregate.Order(message.UserId, message.UserName, address, message.CardTypeId, message.CardNumber, message.CardSecurityNumber, message.CardHolderName, message.CardExpiration);
