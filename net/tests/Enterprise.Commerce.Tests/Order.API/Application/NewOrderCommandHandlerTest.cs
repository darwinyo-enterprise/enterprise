...
namespace Enterprise.Commerce.Tests.Order.API.Application
{
    public class NewOrderRequestHandlerTest
    {
        ...
        private global::Order.Domain.AggregatesModel.OrderAggregate.Order FakeOrder()
        {
            return new global::Order.Domain.AggregatesModel.OrderAggregate.Order("1", "fakeName", new Address("street", "city", "state", "country", "zipcode"), 1, "12", "111", "fakeName", DateTime.Now.AddYears(1));
        }
